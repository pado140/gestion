...
public class loadFrame_old extends javax.swing.JDialog implements Observateurs{
     private final ConnectionDb conn=ConnectionDb.instance();
     private Map<String,Map<String,Integer>> listData;

    public loadFrame_old(Frame owner, boolean modal) {
        super(owner, modal);
        initComponents();
 ...
 txt_box.setText(String.valueOf(grid_po.getRowCount()));
    ...
    private String Order_Exist(String Po,String part_id){
         try {
             ...
             Logger.getLogger(loadFrame_old.class.getName()).log(Level.SEVERE, null, ex);
         } 
         return null;
    }
